...
{
	//класс отвечающий за перевод различных форматов в массив байтов и обратную операцию
	...
	{  
		//возвращает поток как массив байтов
		get  
		{  
	...
	public SerializeManager(byte[] ByteArray)  
	{
		//получаем поток из массива байтов, нужно для обратной десериализации
		byteArray = ByteArray;  
